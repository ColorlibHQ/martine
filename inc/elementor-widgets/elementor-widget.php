    ...
    final class Martine_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'martine-map-custom', MARTINE_DIR_ELEMENTOR . 'assets/js/map-custom.js', array(), '1.0-s2', true );

            // martine companion main js
            wp_enqueue_script( 'martine', MARTINE_DIR_ELEMENTOR . 'assets/js/martine-companion-main.js', array( 'martine-ui-js' ), '1.0-s2', true );
