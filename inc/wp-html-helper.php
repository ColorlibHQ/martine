...
// image default alt
if( !function_exists( 'martine_img_default_alt' ) ){
	function martine_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'martine_img_tag' ) ){
	function martine_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = martine_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'martine_anchor_tag' ) ){
	function martine_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'martine_heading_tag' ) ){
	function martine_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'martine_paragraph_tag' ) ){
	function martine_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'martine_other_tag' ) ){
	function martine_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'martine_button_element ' ) ){
	function martine_button_element( array $args ){
