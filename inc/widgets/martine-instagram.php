...
----------------------------------------*/
class martine_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('martine_instagram_photo',esc_html__('[ Martine ] Intagram Photo','martine'),array(
			'description' => esc_html__('Martine Instagram Photo Widget','martine'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'martine');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'martine'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'martine'); ?></label>
...
if(!function_exists('martine_instagram_widgets')):
	function martine_instagram_widgets(){
		register_widget('martine_instagram_photo');
	}
	add_action('widgets_init','martine_instagram_widgets');
endif;
